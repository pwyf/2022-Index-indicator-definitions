Feature: Budget
  ...
  Scenario Outline: Budget available forward annually
    Given the activity is current
     ...
     And `activity-date[@type="3"]/@iso-date | activity-date[@type="4"]/@iso-date | activity-date[@type="end-planned"]/@iso-date | activity-date[@type="end-actual"]/@iso-date` is at least 6 months ahead
